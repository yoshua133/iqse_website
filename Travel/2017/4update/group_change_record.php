...
mysql_query("UPDATE PW2017needgroup SET email='$ud_email' , dbtg='$ud_dbtg' , dblg='$ud_dblg', dbrcg='$ud_dbrcg' , invitedby='$ud_invitedby' WHERE name='$ud_name'");

echo "<center><br><h3> Your Bulletin Board Information has been Updated successfully.<br>
<a href=\"../PW2017.php\">Click</a> to return to the Travel Website.</h3></center>";
