...
<a href="PW2017.php">[return PW2017 travel page]</a><br><center><h2> Travel Group Bulletin Board</h2></center><br>
</td></tr></table>
...
<td valign=\"top\"><b>Name:</b></td><td valign=\"top\"> <b>Email Address:</b></td><td valign=\"top\"><b>Lodging Group Needed Also?</b></td></tr>
<?php
$query=" SELECT * FROM PW2017needgroup WHERE dbtg='yes' ORDER BY name DESC";
...
echo "<td valign=\"top\">". $dblg."</td><td>";?></div>
</td>
</tr>
<?php
++$i;
