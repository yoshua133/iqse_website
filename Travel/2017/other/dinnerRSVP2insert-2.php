...
$sql="INSERT INTO TAMUPQE2015dinner2 (name, title, dept, affil, email, gname, gtitle, gdept, gaffil, veggie) VALUES ('$_POST[name]', '$_POST[title]', '$_POST[dept]', '$_POST[affil]', '$_POST[email]', '$_POST[gname]', '$_POST[gtitle]', '$_POST[gdept]', '$_POST[gaffil]', '$_POST[veggie]')";

if (!mysql_query($sql,$link))
  {
  die('Error: ' . mysqli_error());
  }
echo "<br> <center><h3>Thank you for RSVP'ing!</h3></center>";

mysql_close($link)
?>
<center><br><h3><a href="TAMUPQE.php">click to return to the main event page</a></h3></center>
