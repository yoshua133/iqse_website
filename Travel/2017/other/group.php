...
<div align="center"><h2><font color="#500000">RSVP for Buffet Reception </h2></font><br></div>
 <br> <center>
  <br> (<font color="#FF0000"><b>ALL Fields Required</b></font>) <br><br>
<form action="dinnerRSVP2insert.php" method="POST">
<center> <table width="500" cellpadding="10" cellspacing="0" border="0" >
  <tr><!-- Row 1 -->
     <td align="center" width="200"><div align="center">Name:</div></td><!-- Col 1 -->
     <td><input type="text" size="35"  name="name" value="as will appear on name badge"></td><!-- Col 2 -->
  </tr>
  </tr>
    <tr><!-- Row 3 -->
     <td align="center" width="200"><div align="center">Title:</div></td><!-- Col 1 -->
     <td><input type="text" size="35"  name="title" value="Professor, Graduate Student, etc." ></td><!-- Col 2 -->
  </tr>
  <tr><!-- Row 2 -->
     <td align="center" width="200"><div align="center">Department:</div></td><!-- Col 1 -->
     <td><input type="text" size="35"  name="dept" value="IQSE" ></td><!-- Col 2 -->
  </tr>
  <tr><!-- Row 2 -->
     <td align="center" width="200"><div align="center">Affiliation:</div></td><!-- Col 1 -->
     <td><input type="text" size="35"  name="affil" value="TAMU"></td><!-- Col 2 -->
  ...
  <tr><!-- Row 2 -->
	 ...
	 <tr><!-- Row 2 -->
     <td align="center" width="200"><div align="center">Number of Vegetarian Meals Needed:</div></td><!-- Col 1 -->
     <td><input type="text" size="35"  name="veggie" value="n/a"></td><!-- Col 2 -->
	 </tr>
	 <tr>
