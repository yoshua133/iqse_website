...
<div align="center"><h2><font color="#500000">Join a Lodging Group</h2></font><br></div>
 <br> <center>
 <form action="room2insert.php" method="POST">
<center> <table width="500" cellpadding="10" cellspacing="0" border="0" >
  <tr><!-- Row 1 -->
    ...
    <tr><!-- Row 3 -->
     <td align="center" width="200"><div align="center">Join Lodging Group Number:<br><small>(enter 1,2,3, etc.)</small></div></td><!-- Col 1 -->
