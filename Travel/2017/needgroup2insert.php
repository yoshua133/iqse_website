...
$sql="INSERT INTO PW2017needgroup (name, dbtg, dblg, dbrcg, email, invitedby ) VALUES ('$_POST[name]', '$_POST[dbtg]', '$_POST[dblg]', '$_POST[dbrcg]','$_POST[email]', '$_POST[invitedby]')";
...
mysql_close($link)
?>
<center><br><h3><a href="PW2017.php">click to return to the main page</a></h3></center>
