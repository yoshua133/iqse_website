...
$sql="INSERT INTO TAMUPW2016dinner (name, title, dept, affil, email, gname, gtitle, gdept, gaffil, veggie) VALUES ('$_POST[name]', '$_POST[title]', '$_POST[dept]', '$_POST[affil]', '$_POST[email]', '$_POST[gname]', '$_POST[gtitle]', '$_POST[gdept]', '$_POST[gaffil]', '$_POST[veggie]')";
