...
<a href="PW2016.php">[return PW2016 travel page]</a><br><center><h2> Travel Group Bulletin Board</h2></center><br>
</td></tr></table>
...
<?php
$query=" SELECT * FROM PW2016needgroup WHERE dbtg='yes' ORDER BY name DESC";
