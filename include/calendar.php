...
$resultinginsert = mysqli_query($link, $sqlinsert);
if($resultinginsert ){
...
$noOfEvent = mysqli_num_rows(mysqli_query($link, $sqlCount));
if($noOfEvent >= 1){
echo "class='event'";
}
}
...
$resultEvents = mysqli_query($link, $sqlEvent);
...
$pos2=(strlen(stristr($events['talktype'],'Salter Farm'))||strlen(stristr($events['talktype'],'SaFER')));
if($pos>0){echo "<smaller>(<a href=\"event.php?id=".$events['id']."\"><font size=\"2\">Announcement</font></a>)</smaller><br>";}elseif($pos2>0){echo "<smaller>(<a href=\"eventSaFER.php?id=".$events['id']."\"><font size=\"2\">Announcement</font></a>)</smaller>";}else{echo "<smaller>(<a href=\"".$events['dbwaddress']."\"><font size=\"2\">Event Website</font></a>)</smaller>";}}
echo "</div></td>";}
echo "</tr>";
?>
</table></div>
