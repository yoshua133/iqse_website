...
<?php
$query=" SELECT * FROM IQSEevent WHERE talkyear='2016' AND talktype LIKE '%Chancellor%' ORDER BY ABS(dborder) ASC";
...
<td width="22%" align="center" nowrap>
<small><?php echo "<a href=\"WDLS/2016/WDLS.php?id=".$id."\"> Event Website </a>";?><br>
</td>
</tr>
<?php
++$i;
