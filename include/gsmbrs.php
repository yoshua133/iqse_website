...
<?php
$query2=" SELECT * FROM IQSEpeople WHERE dbgroupmbr LIKE '%$uname%' AND classification='gs'AND dbstatus='active' ORDER BY last ASC";
...
echo "<h4><font face=\"Arial\">Graduate Students</font></h4>";
...
<tr valign="top">
<td width="30%">
<?php if($classification='gs'){echo "<a href=\"gs.php?uname=".$uname."\"> ".$first." ".$last." </a>";}
