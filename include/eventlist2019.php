...
<tr><td>
<div align="center"><font size="5" color="500000"><b>2019</b></font></div>
</td></tr>
<tr>
<td>
...
<?php
$query=" SELECT * FROM IQSEevent WHERE talkyear='2019' AND dbcomment6 LIKE '%no%' ORDER BY ABS(dborder) ASC";
...
<td width="25%" align="center" nowrap>
<small><?php $pos=(strlen(stristr($talktype,'seminar'))||strlen(stristr($talktype,'colloquium'))||strlen(stristr($talktype,'OSA Student'))||strlen(stristr($talktype, 'Student Meeting')));
$pos2=(strlen(stristr($talktype,'Salter Farm'))||strlen(stristr($talktype,'SaFER')));
if($pos>0){echo "<a href=\"event.php?id=".$id."\"> Announcement </a>"; echo "<br>($speakername)";}elseif($pos2>0){echo "<a href=\"eventSaFER.php?id=".$id."\"> Announcement</a><br> (<a href=\"http://iqse.tamu.edu/ART\">ART</a>/<a href=\"http://iqse.tamu.edu/SaFER\">SaFER</a>)";}else{echo "<a href=\"".$dbwaddress."\">Event Website</a>";}?><br>
</td>
</tr>
<?php
++$i;
