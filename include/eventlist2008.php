...
<tr><td>
<div align="center"><font size="5" color="500000"><b>2008</b></font></div>
</td></tr>
<tr>
<td>
...
<?php
$query=" SELECT * FROM IQSEevent WHERE talkyear='2008' AND dbcomment6 LIKE '%no%' ORDER BY ABS(dborder) ASC";
...
<td width="25%" align="center" nowrap>
<small><?php $pos=(strlen(stristr($talktype,'seminar')));
if($pos>0){echo "<a href=\"event.php?id=".$id."\"> Announcement </a>"; echo "<br>(Dr. $speakername)";}else{echo "<a href=\"".$dbwaddress."\">Announcement</a>"; echo "<br>($speakername)";}?><br>
</td></tr>
<?php
++$i;
}
