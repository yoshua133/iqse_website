...
<?php
$query=" SELECT * FROM IQSEhonors WHERE year='2015' AND dbcomment1!='yes' ORDER BY ABS(himg3) DESC";
...
<div align="center">
<?php if($awardee2=='none'){echo "<img src=\"people/images/".$awardee1.".jpg\" height=\"200\" />";}else{echo "<img src=\"people/images/".$awardee1.".jpg\" height=\"200\" />&nbsp;&nbsp;<img src=\"people/images/".$awardee2.".jpg\" height=\"200\" />"; }?>
<?php if($himg1='none'){;}else{echo "<img src=\"people/images/".$himg1.".jpg\" height=\"200\" />";}?> </div><br>
</td>
<td width="55%" valign="top">
<font face="Arial"><div align="left"><?php if($awardee2=='none'){echo "<b>".$awardeename1."</b>&nbsp; receives &nbsp;<b>".$awardname."</b>&nbsp; on &nbsp;".$datereceived."&nbsp; at &nbsp;".$placereceived."";}else{echo "<b>".$awardeename1."&nbsp; and &nbsp; ".$awardeename2."&nbsp;</b>  receive &nbsp;<b> ".$awardname."&nbsp; </b>on &nbsp; ".$datereceived."&nbsp; at &nbsp;".$placereceived."";}
...
if($tlink3=='none'){;}else{echo "<a href=\"".$tlink3."\">Additional Information</a><br>";} ?>
</div>
</font></td>
</tr>
<?php
