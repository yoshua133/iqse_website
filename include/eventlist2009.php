...
<tr><td>
<div align="center"><font size="5" color="500000"><b>2009</b></font></div>
</td></tr>
<tr>
<td>
...
<?php
$query=" SELECT * FROM IQSEevent WHERE talkyear='2009' AND dbcomment6 LIKE '%no%' ORDER BY ABS(dborder) ASC";
