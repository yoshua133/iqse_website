...
<tr><td>
<div align="center"><font size="5" color="500000"><b>2016 Distinguished Lecturers</b></font></div>
</td>
</tr>
</table>
<?php
...
<?php
$query=" SELECT * FROM IQSEevent WHERE talkyear='2016' AND talktype LIKE '%Faculty%' ORDER BY ABS(dborder) ASC";
...
<td width="22%" align="center" nowrap>
<small><?php echo "<a href=\"IQSEFaculty/2016/FL.php?id=".$id."\"> Event Website </a>";?><br>
</td>
</tr>
<?php
++$i;
