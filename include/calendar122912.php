...
<div align="center"><h1>IQSE CALENDAR</h1></div>
...
echo "*<small>".$events['talktype']."&nbsp;<br></small>";
$pos=((strlen(stristr($events['talktype'],'seminar')))||(strlen(stristr($events['talktype'],'colloquium')))||(strlen(stristr($events['talktype'],'OSA Student'))));
if($pos>0){echo "<small>(<a href=\"event.php?id=".$events['id']."\">Announcement </a>)</small><br>";}else{echo "<small>(<a href=\"".$events['dbwaddress']."\">Event Website</a>)</small>";}}
echo "</div></td>";}
echo "</tr>";
?>
</table></div>
