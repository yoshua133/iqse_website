...
<?php if($dbcomment3=='none'){echo "";}else{echo "<hr><a href=\"publist.php?uname=".$uname."\"> <h3><font color=\"#500000\"><font face=\"Arial\">Publication List (partial)</font></font></h3></a><br>";}?>
		<br><br>
		<hr>
