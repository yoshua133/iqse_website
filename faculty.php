...
<?php if($dbcomment3=='none'){echo "";}else{echo "<a href=\"publist.php?uname=".$uname."\"> <b>Publication List (partial)</b></a><br>";}?>
...
<table cellpadding="10" width=90%><tbody style="font-family:arial">
<tr><td align="left">
...
<?php
$query2=" SELECT * FROM IQSEpeople WHERE dbgroupmbr LIKE '%$uname%' AND dbstatus='active'";
...
echo "<hr><h3><font face=\"Arial\">Group Members:</font></h3>"; ?> 
<?php
