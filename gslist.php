...
<title>IQSE Graduate Student List</title>
...
<tr>
<td>
<div align="center"><font size="5" color="500000"><b>GRADUATE STUDENTS</b></font></div>
</td>
</tr>
</table>
...
<?php
$query=" SELECT * FROM IQSEpeople WHERE classification='gs' AND dbstatus='active' ORDER BY last ASC";
...
<small><?php if($classification='gs'){echo "<a href=\"gs.php?uname=".$uname."\"> ".$last.",&nbsp;".$first." </a>";}
...
<br>
 <hr><center>
<p class="c2"><font face="Arial">Last update: 29 December 2012</font></p></center>	<br> 
