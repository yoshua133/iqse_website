...
<h3>U.S. Faculty, Graduate or Undergraduate Student (Non US Citizen)</h3><br>

<h4>If you are currently working in the U.S. and are not a U.S. citizen, a State of Texas, or TAMU employee, the following should be sent to  <a href="mailto:tengma@tamu.edu?subject=Foreign Faculty, GS, UG Documents"> Mr. Teng Ma</a>:

<ul>
	<li>Current CV</li>
	<li>Copy of Visa</li>
	<li>Copy of Passport with status of entry clearly visible</li>
	<li>Copy of I-94</li>
	<li><a href="forms/sponsorletter.doc">Visa Sponsor Letter(s)</a>-signed by your Institution's International Office and supervisor.</li>
</ul></h4><br>
<br>
<br><br>
