...
<center>  <h3> Need Transportation "Yes" List</h3></center><br><br>
...
$result = mysqli_query($link, "SELECT * FROM SSRegForm WHERE transplan LIKE '%yes%' ORDER BY last ASC" )
or die("SELECT Error: ".mysqli_error());
$num_rows = mysqli_num_rows($result);
if ($myrow = mysqli_fetch_array($result)) {

echo "<center><table border=1>\n";
echo "<tr><td><b>Transportation Needed?:</b></td><td><b>Arrival Info:</b></td><td><b>Departure Info:</b></td><td><b>Last Name:</b></td><td><b>First Name:</b></td><td><b>Email:</b></td><td><b>Status:</b></td><td><b>Gender:</b></td></tr>\n";
do {
printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["transplan"],$myrow["arrival"],$myrow["depart"],$myrow["last"], $myrow["first"], $myrow["email"],$myrow["status"],$myrow["gender"]);
