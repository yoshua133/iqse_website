...
<center>  <h3> Registered Roommate List</h3></center><br>

This list shows if you have requested a roommate and if so, who you requested. <br>
...
echo "<table border=1>\n";
echo "<tr><td><b>Last Name:</b></td><td><b>First Name:</b></td><td><b>Email:</b></td><td><b>Last Name:</b></td><td><b>First Name:</b></td><td><b>Email:</b></td></tr>\n";
do {
printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["ylast"], $myrow["yfirst"], $myrow["yemail"],$myrow["rlast"], $myrow["rfirst"], $myrow["remail"]);
