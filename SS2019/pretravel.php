...
if($session->logged_in){
   ?>
<center><h3> Pre-Travel: Before Making Reservations</h3></center><br>
<h4>Please select your status from list:<br><br>

<ul>
    <li><a href="tamuemp.php">Texas A&M University (TAMU) Employee</a></li>
    <li><a href="tamugs.php">Texas A&M University Student - Not Employed by TAMU</a></li>
    <li><a href="stateemp.php">State of Texas Employee - Non TAMU</a></li>
    <li><a href="uscit.php">U.S. Faculty, Graduate or Undergraduate Student (US Citizen)</a></li>
    <li><a href="usnoncit.php">U.S. Faculty, Graduate or Undergraduate Student (Non US Citizen)</a></li>
    <li><a href="foreign.php">Foreign Faculty, Graduate or Undergraduate Student</a><br><br></li>
</ul> 
For more information email: <a href="mailto:tengma@tamu.edu?subject=Before Making Reservation Info Request">tengma@tamu.edu</a>
</h4>
<br><br><br>
<br><br>
