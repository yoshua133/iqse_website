...
<?php
   ...
   echo "<h4><center>[<a href=\"userinfo.php?user=$session->username\">My Account</a>] &nbsp;&nbsp;";
   echo "[<a href=\"useredit.php\">Edit Account</a>] &nbsp;&nbsp;";
   if($session->isAdmin()){
      echo "[<a href=\"admin/admin.php\">Admin Center</a>] &nbsp;&nbsp;";
   }
   echo "[<a href=\"process.php\">Logout</a>]&nbsp;&nbsp;";
   echo "[<a href=\"mailto:iqse@tamu.edu?subject=SS2019 Information Request\">Contact</a>]&nbsp;&nbsp;</center>";?> </h4>
<?php   
/**
