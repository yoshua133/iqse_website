...
<h3>TAMU Travel Groups</h3>
          <h4><ul>
              <li class="first"><a href="trvlgrpguide.php">Guidelines</a></li>
              <li><a href="grpreg.php">Register</a></li>
              <li><a href="travelboard.php">Bulletin Board</a></li>
              <li><a href="travellist.php">Current List</a></li>
          </ul></h4>
