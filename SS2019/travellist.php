...
<center><h3> Current Travel Group List</h3></center>



<table width="95%" cellpadding="5" border="0" cellspacing="1"><tbody style="font-family:arial">

<?php include("include/sql_result.php"); ?>
<?php include("include/travel1.php"); ?>
<?php include("include/travel2.php"); ?>
<?php include("include/travel3.php"); ?>
<?php include("include/travel4.php"); ?>
<?php include("include/travel5.php"); ?>
<?php include("include/travel6.php"); ?>
<?php include("include/travel7.php"); ?>
<?php include("include/travel8.php"); ?>
<?php include("include/travel9.php"); ?>
<!-- <?php include("include/travel10.php"); ?>
<?php include("include/travel11.php"); ?>
<?php include("include/travel12.php"); ?> 
