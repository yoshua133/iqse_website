...
$sql="INSERT INTO SS2019invite (tdate, fname, lname, username, title, addressline1, addressline2, addressline3, addressline4) VALUES ('$_POST[tdate]', '$_POST[fname]', '$_POST[lname]', '$_POST[username]', '$_POST[title]', '$_POST[addressline1]', '$_POST[addressline2]', '$_POST[addressline3]', '$_POST[addressline4]')";

if (!mysqli_query($link, $sql))
  {
  die('Error: ' . mysqli_error());
  }
echo "<br> <center><h3>Thank you for submitting your invitation request information. To view the invitation letter, click on the link below!</h3><br><br>
<a href=\"invitation.php\" target=\"_blank\">CLICK TO VIEW INVITATION LETTER</a>
</center>";
