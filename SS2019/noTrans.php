...
<center>  <h3> Need Transportation "No" List</h3></center><br><br>
...
$result = mysqli_query($link, "SELECT * FROM SSRegForm WHERE transplan='no' ORDER BY last ASC" )
or die("SELECT Error: ".mysqli_error());
$num_rows = mysqli_num_rows($result);
if ($myrow = mysqli_fetch_array($result)) {

echo "<center><table border=1>\n";
echo "<tr><td><b>Transportation Needed?:</b></td><td><b>Last Name:</b></td><td><b>First Name:</b></td><td><b>Email:</b></td></tr>\n";
do {
printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["transplan"],$myrow["last"], $myrow["first"], $myrow["email"]);
