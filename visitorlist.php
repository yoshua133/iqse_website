...
<tr>
<td>
<div align="center"><font size="5" color="500000"><b>VISITORS</b></font></div>
</td>
</tr>
</table>
...
<?php
$query=" SELECT * FROM IQSEpeople WHERE classification='visitor' AND dbstatus='active' ORDER BY last ASC";
...
<small><?php if($classification='visitor'){echo "<a href=\"visitor.php?uname=".$uname."\"> ".$last.",&nbsp;".$first." </a>";}
