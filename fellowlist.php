...
<tr>
<td>
<div align="center"><font size="5" color="500000"><b>FELLOWS</b></font></div>
</td>
</tr>
</table>
...
<?php
$query=" SELECT * FROM IQSEpeople WHERE classification='fellow' AND dbstatus='active' ORDER BY last ASC";
...
<small><?php if($classification='faculty'){echo "<a href=\"fellow.php?uname=".$uname."\"> ".$last.",&nbsp;".$first." </a>";}
...
<br><br><br><br><br><br>
 <hr><center>
<p class="c2"><font face="Arial">Last update: April 4, 2013</font></p></center>	<br> 
