...
extract($_POST); 
$sql="INSERT INTO SaFERinsects(dbcolor1, dbcolor2, dbcolor3, legs6or8, winged, dbspecial, dbtype, dbhabit, dbhabitat, familyname, sciname, commonname, dbname, dbphoto1, dbphoto2, dbphoto3, dbphoto4, dbphoto5, insectlink, dbdescription, dbdescription2) VALUES ('$dbcolor1', '$dbcolor2','$dbcolor3',  '$legs6or8', '$winged','$dbspecial','$dbtype','$dbhabit','$dbhabitat','$familyname', '$sciname', '$commonname', '$dbname', '$dbphoto1','$dbphoto2','$dbphoto3', '$dbphoto4', '$dbphoto5','$insectlink','$dbdescription','$dbdescription2')";
