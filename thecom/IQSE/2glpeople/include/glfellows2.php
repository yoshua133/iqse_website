...
<body>
<center><h3>IQSE Fellows</h3></center>
<center>
...
$query=" SELECT * FROM IQSEpeople WHERE classification='fellow' AND dbgroupmbr Like '%$uname%' AND dbstatus='active'ORDER BY last ASC";
