...
<body>
<center><h3>Postdoctoral Research Associates</h3></center>
<center>
<table width="96%" cellpadding="5" cellspacing="0" border="1" bgcolor="#C0C0C0">
<tr valign="top">
...
$query=" SELECT * FROM IQSEpeople WHERE classification='researcher' AND dbgroupmbr Like '%$uname%' AND dbstatus='active'ORDER BY last ASC";
...
$split = 5;
?>
<?php If(($i) % ($split) == $split-1){echo "</td><td width=\"15%\">&nbsp;<br><center><img src=\"../../../people/images/".$uname.".jpg\" height=\"150\" /> <br> <b><font size=\"+1\">$first &nbsp; $last</font></b></center> <br> </td></tr><tr valign=\"top\">";}
else{ echo "<td width=\"15%\"> &nbsp;<center><img src=\"../../../people/images/".$uname.".jpg\" height=\"150\" /> <br> <b><font size=\"+1\">$first &nbsp; $last</font></b></center> <br> ";}?>
