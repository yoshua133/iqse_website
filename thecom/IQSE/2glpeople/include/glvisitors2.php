...
<body>
<center><h3>Visiting Scholars</h3></center>
<center>
...
$query=" SELECT * FROM IQSEpeople WHERE classification='visitor' AND dbgroupmbr Like '%$uname%' AND dbstatus='active'ORDER BY last ASC";
