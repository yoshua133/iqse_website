...
?>
<html><head><title>Honors and Awards Update Form</title>
</head>
<body>
...
$result = mysql_query( "SELECT * FROM IQSEhonors ORDER BY id DESC" )
...
echo "<tr><td><b>ID:</b></td><td><b>Award Name:</b></td><td><b>Award Winner:</b></td><td><b>Year Received:</b></td></tr>\n";
do {
printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["id"], $myrow["awardname"], $myrow["awardeename1"], $myrow["year"]);
