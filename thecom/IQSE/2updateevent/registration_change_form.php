...
<tr align="center" valign="top">
<td align="center" colspan="1">
Multi-Day Event Listing?: <br><small> 1st occurence="no"</small>
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbcomment6" value="<?php echo "$dbcomment6"?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Talk Time: <br>
...
<input type="text" size="35"  name="ud_dbsponsor" value="<?php echo "$dbsponsor"?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Refreshment Comment: <br>
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbfood" value="<?php echo "$dbfood"?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Speaker's Host: <br>
...
<tr align="center" valign="top">
<td align="center" colspan="1">
Comment 3: SWDLS Event Website Location<br>
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbcomment3" value="<?php echo "$dbcomment3"?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Comment 4: SWDLS reception<br>
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbcomment4" value="<?php echo "$dbcomment4"?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Comment 5: SWDLS assigned speaker uname<br>
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbcomment5" value="<?php echo "$dbcomment5"?>"><br>
</td></tr>
