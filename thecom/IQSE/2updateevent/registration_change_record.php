...
mysql_query("UPDATE IQSEevent SET talktype='$ud_talktype', speakertitle='$ud_speakertitle' , speakername='$ud_speakername' , speakeraffil='$ud_speakeraffil' , speakerabstract='$ud_speakerabstract' , talkdate='$ud_talkdate' , talktime='$ud_talktime', talkloc='$ud_talkloc', speakerhost='$ud_speakerhost', hostemail='$ud_hostemail', dbposter='$ud_dbposter' ,  talkbuilding='$ud_talkbuilding', talkyear='$ud_talkyear', eventDate='$ud_eventDate', dborder='$ud_dborder', dbwaddress='$ud_dbwaddress', dbsponsor='$ud_dbsponsor', dbfood='$ud_dbfood', dbcomment1='$ud_dbcomment1', dbcomment2='$ud_dbcomment2', dbcomment3='$ud_dbcomment3', dbcomment4='$ud_dbcomment4', dbcomment5='$ud_dbcomment5', dbcomment6='$ud_dbcomment6' WHERE id='$ud_id'");
