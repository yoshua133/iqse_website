...
<body>
<form name="setup_reminder" action="reminder/reminder_setup.php" method="post">
...
mysql_query( "INSERT INTO IQSEreminders(`reminder_name`, `reminder_desc`, `reminder_date`) VALUES('".addslashes($_POST['reminder_name'])."', '".addslashes($_POST['reminder_desc'])."', '".addslashes($reminder_date)."')" );
// Let's go to the Reminder List page
Header("Refresh: 1;url=http://iqse.tamu.edu/reminder/reminder_list.php");
echo <<< _HTML_END_
