...
?>
<html><head><title>Reminder Update Form</title>
</head>
<body>
...
<input type="text" name="reminder_id" size="30">
...
$result = mysql_query( "SELECT * FROM IQSEreminders ORDER BY reminder_id DESC" )
...
echo "<tr><td><b>ID:</b></td><td><b>Trigger Date:</b></td><td><b>Reminder Name</b></td><td><b>Reminder Description:</b></td><td><b>Notification Email:</b></td></tr>\n";
do {
printf("<tr><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["reminder_id"], $myrow["reminder_date"], $myrow["reminder_name"], $myrow["reminder_desc"], $myrow["dbemail"]);
