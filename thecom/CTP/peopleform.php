 ...
 */
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://iqse.tamu.edu/thecom/CTP/CTP-2.php');
   
   /**
    * The address of the database where the form results 
    * will be saved.
    */
   define('CC_FB_DB_ADDRESS', 'sql.physics.tamu.edu');
   /**
