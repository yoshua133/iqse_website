...
<form method="POST" action="IQSERR_check_form.php">
<pre>
&nbsp;&nbsp;<h2>Enter Reference Number of Book to be Checked Out:</h2> <br>
...
echo "<center><br>List of Books by Reference Number<br><br>";
echo "<table border=1>\n";
