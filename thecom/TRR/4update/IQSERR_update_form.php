...
if(!isset($_SESSION['logged_in'])){ 
  echo('<center><h2><font color="#500000">You are not logged in!</font> </h2><br> <a href="../TRR.php">Login?</a>'); 
    ...
    { 
?> 
<html><head><title>Book Update Form</title>
</head>
<body>
...
<pre>
&nbsp;&nbsp;<b><h2>Enter <font color="#FF0000"><u>ID Number</u> (not Reference Number)</font> of book to Edit:</b></h2> <br>
...
echo "<tr><td><b><font color=\"#FF0000\">ID#</font></b></td><td><b>Reference #</b></td><td><b> Title</b></td><td><b>1st Author Last Name</b>:</td></tr>\n";
do {
printf("<tr><td><b><font color=\"#FF0000\">%s</font></b></td><td>%s</td><td>%s</td><td>%s</td></tr>\n", $myrow["id"], $myrow["reference"], $myrow["title"], $myrow["lastauthor"]);
