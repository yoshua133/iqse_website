...
mysql_query(" UPDATE IQSERR SET title='$ud_title', author='$ud_author',  lastauthor='$ud_lastauthor', publish='$ud_publish' , description='$ud_description', location='$ud_location', ISBN='$ud_ISBN', subject='$ud_subject', evans='$ud_evans', comment1='$ud_comment1',  comment2='$ud_comment2', comment3='$ud_comment3' , donator='$ud_donator', donatedate='$ud_donatedate', missing='$ud_missing', reference='$ud_reference' WHERE id='$ud_id'");



echo "<center><h3> Event has been Updated successfully.</h3> Return to <a href=\"../TRR-1.php\">TRR Module</a></center>";
