...
<center> <table width="500" cellpadding="10" cellspacing="0" border="1" >
  ...
  <tr><!-- Row 4 -->
     <td align="center" width="200"><div align="center"><font color="#FF0000">**</font>Comment 1</div></td><!-- Col 1 -->
...
<tr><!-- Row 4 -->
  ...
  <tr><!-- Row 4 -->
     ...
     <td><input type="text" size="100"  name="dbcomment 6" ></td><!-- Col 2 -->
  </tr>
  <tr>
  <td align="right"><P> <strong> Description:</strong><br></td>
<td><textarea name="message" cols=55 rows=25 wrap=virtual>Write any messages to
user here.
</textarea></p>
</tr>
</table><br><br>
