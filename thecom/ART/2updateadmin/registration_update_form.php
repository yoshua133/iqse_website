...
?>
<html><head><title><font face="Arial">People Update Form</font></title>
</head>
<body>
...
<pre>
&nbsp;&nbsp;<font face="Arial">Enter Username to Edit:</font> <br>
...
$result = mysql_query( "SELECT * FROM ARTpeople ORDER BY last ASC" )
