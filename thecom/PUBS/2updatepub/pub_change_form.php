...
<html><head><title>Modify Publication Form</title>
<style type="text/css">
...
<h3>Publication Modification Form</h3>
...
<tr align="center" valign="top">
<td align="center" colspan="1">
Publication Information <small>(format: Doe, J. and Smith, J., "Title", Journal, vol., pp/art no. (year))</small>: 
</td><td align="center" colspan="1">
<input type="text" size="35"  name="ud_dbpub" value="<?php echo "$dbpub"; ?>"><br>
</td></tr>
<tr align="center" valign="top">
<td align="center" colspan="1">
Authors IQSE Assigned Unames (usernames, e.g., asokolov, mscully, mszubairy): 
</td><td align="center" colspan="1">
