...
$sql="INSERT INTO WDLS$id (name, title, dept, affil, email, gname, gtitle, gdept, gaffil) VALUES ('$_POST[name]', '$_POST[title]', '$_POST[dept]', '$_POST[affil]', '$_POST[email]', '$_POST[gname]', '$_POST[gtitle]', '$_POST[gdept]', '$_POST[gaffil]')";
...
mysql_close($link)
?>
<center><br><h3><?php echo "<a href=\"WDLS.php?id=".$id."\">Return to Event Website </a>";?></h3></center>
