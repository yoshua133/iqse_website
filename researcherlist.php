...
<title>IQSE Researcher List</title>
...
<tr>
<td>
<div align="center"><font size="5" color="500000"><b>RESEARCHERS</b></font></div>
</td>
</tr>
</table>
...
<?php
$query=" SELECT * FROM IQSEpeople WHERE classification='researcher' AND dbstatus='active' ORDER BY last ASC";
...
<small><?php if($classification='researcher'){echo "<a href=\"researcher.php?uname=".$uname."\"> ".$last.",&nbsp;".$first." </a>";}
